...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # inject call the block for each element of array
    # result of block save in first argument and send it to the next block
    # in brackets we can select the start value from array
  end
